<nav class="navigation d-flex flex-column text-center navbar navbar-light hide-scrollbar">
    ...
    <ul class="d-flex nav navbar-nav flex-row flex-xl-column flex-grow-1 justify-content-between justify-content-xl-center align-items-center w-100 py-4 py-lg-2 px-lg-3" role="tablist">
        ...
        <!-- New chat -->
        <li class="nav-item">
            <a class="nav-link py-0 py-lg-8" id="tab-create-chat" href="{{ route('create_chat') }}" title="Create chat">
                <div class="icon icon-xl">
        ...
        <!-- Friends -->
        <li class="nav-item">
            <a class="nav-link py-0 py-lg-8" id="tab-friends" href="{{ route('friends') }}" title="Friends">
                <div class="icon icon-xl">
        ...
        <!-- Chats -->
        <li class="nav-item">
            <a class="nav-link active py-0 py-lg-8" id="tab-chats" href="{{ route('dashboard') }}" title="Chats">
        ...
        <!-- Notification -->
        <li class="nav-item">
            <a class="nav-link py-0 py-lg-8" id="tab-notifications" href="{{ route('notifications') }}" title="Notifications" role="tab">
                <div class="icon icon-xl">
        ...
        <li class="nav-item d-none d-xl-block">
            <a class="nav-link py-0 py-lg-8" id="tab-settings" href="{{ route('settings') }}" title="Settings" role="tab">
                <div class="icon icon-xl">
